...
tags: [WriteUp, Vintage, HTB, Enumeration, Active Directory, RID Bruteforcing, ResetPassword, password reuse, MSSQL, DisabledUser, RealmFix, Hash Cracking, Kerberoasting, Lateral Movement, Bloodhound, DPAPI, VaultCred, Privilege Escalation, Windows]
